...
class User extends Db{
    ...
    {
        $sql = "INSERT INTO bannis (id_bannis, date_debutBan, date_finBan, ban_perma, raison_ban) 
    ...
    public function getBannedUsers()
    {
        $sql = "SELECT u.*, b.date_debutBan, b.date_finBan, b.ban_perma, b.raison_ban
                FROM utilisateur u 
                JOIN bannis b ON u.id_utilisateur = b.id_bannis";
        return $this->query($sql)->fetchAll();
    }

    public function unbanUser($userId)
    {
        $sql = "DELETE FROM bannis WHERE id_bannis = :userId";
