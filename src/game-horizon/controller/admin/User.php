    ...
    public function index()
{
    ...
    $this->view->Display('admin/user', ['users' => $activeUsers, 'bannedUsers' => $bannedUsers]);
}
    ...
    public function edit_user($vars)
    {
        ...
        $userGames = $userModel->getUserGames($userId);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($action === 'reset_image') {
                ...
                $data = ['chemin_img_user' => '/img/utilisateurs/user.png'];
        ...
        $this->view->Display('admin/edit_user', [
            'user' => $user,
            'userGames' => $userGames
        ]);
    }
    ...
    public function ban_user($vars)
    {
        ...
        $this->view->Display('admin/ban_user', ['user' => $user]);
    }
